...
class loggerfunc(object):
    ...
    def __init__(self, level="INFO", run_date="", logfilename="applog", absolutepath="/mnt/applog"):
        """Log level  and folder path for log file is initiazed and created.
        Args:
            level:logging level
            run_date:Date for log folder
            logfilename:name of the log file
            absolutepath:Absolute path inside which under run_date folder will created
